...
import {App} from '../components/CircleChart'
import {RadarComp} from './RadarChartComp'

const RightBody = () => {
  return (
    <div className='col-4 ms-3 d-flex flex-column'>
      <div className='col-12 bg-white d-flex flex-column shadow mt-3 rounded'>
      ...
      <div className='col-12 bg-white d-flex flex-column shadow mt-4 rounded'>
        <div className='col-12 d-flex flex-row align-items-center justify-content-between p-3'>
