    ...
    <div className={`bg-white heightMax col-md-4 pt-3 ps-3 pe-3 position-fixed ${props.style}`}>
        ...
        <div className="collapse" id="Components">
            <ul style={{listStyle:'circle'}} className='txtCol'>
                <li className='p-3 box ms-4'>Alerts</li>
                <li className='p-3 box ms-4'>Accordion</li>
                <li className='p-3 box ms-4'>Badges</li>
                <li className='p-3 box ms-4'>Breadcrumbs</li>
                <li className='p-3 box ms-4'>Buttons</li>
                <li className='p-3 box ms-4'>Cards</li>
                <li className='p-3 box ms-4'>Crousel</li>
                <li className='p-3 box ms-4'>List Groups</li>
                <li className='p-3 box ms-4'>Modal</li>
                <li className='p-3 box ms-4'>Tabs</li>
                <li className='p-3 box ms-4'>Pagination</li>
            </ul>
        </div>
        ...
        <div className="collapse" id="forms">
            <ul style={{listStyle:'circle'}} className='txtCol'>
                <li className='p-3 box ms-4'>Form Elements</li>
                <li className='p-3 box ms-4'>Form Layouts</li>
                <li className='p-3 box ms-4'>Form Editors</li>
                <li className='p-3 box ms-4'>Form Validation</li>
            </ul>
        </div>
        ...
        <div className="collapse" id="Tables">
            <ul style={{listStyle:'circle'}} className='txtCol'>
                <li className='p-3 ms-4'>General Tables</li>
                <li className='p-3 ms-4'>Data Tables</li>
            </ul>
        </div>
        ...
        <div className="collapse" id="Charts">
            <ul style={{listStyle:'circle'}} className='txtCol'>
                <li className='p-3 ms-4'>chart.js</li>
                <li className='p-3 ms-4'>ApexCharts</li>
                <li className='p-3 ms-4'>ECharts</li>
            </ul>
        </div>
        ...
        <div className="collapse" id="Icons">
            <ul style={{listStyle:'circle'}} className='txtCol'>
                <li className='p-3 ms-4'>Bootstrap Icons</li>
                <li className='p-3 ms-4'>Remix Icons</li>
                <li className='p-3 ms-4'>Boxicons</li>
            </ul>
        </div>
